...
initPasswordForm : T -> Model -> Maybe String -> Maybe String -> H.Html Msg
initPasswordForm t model maybeToken errorMessage =
    H.div
            ...
            [ H.form
                ...
                , H.h3
                    ...
                    [ H.input
                        ...
                        , A.autofocus True
                        , A.placeholder <|
                            t "initPassword.passwordPlaceholder"
                        , onInput Password
                        ]
                        []
                    ]
                , H.h3
                    ...
                    [ H.input
                        [ A.type_ "password"
                        , A.placeholder <|
                            t "initPassword.password2Placeholder"
                        , onInput Password2
                        ]
                        []
                    ]
...
view t model maybeToken =
    case model.status of
        NotLoaded ->
            initPasswordForm t model maybeToken Nothing
        ...
        Failure ->
            initPasswordForm t model maybeToken <|
                Just (t "initPassword.failure")

        NetworkError ->
            initPasswordForm t model maybeToken <|
                Just (t "initPassword.networkError")
